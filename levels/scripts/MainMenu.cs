...
public partial class MainMenu : Node
{
	...
	public void _on_stats_button_pressed(){
		GetTree().ChangeSceneToFile("res://scenes/StatsMenu.tscn");
	}
	...
	{
		GetTree().ChangeSceneToFile("res://scenes/lvl_8.tscn");
	}
	public void _on_lvl_9_pressed()
	{
		//GetTree().ChangeSceneToFile("res://scenes/lvl_9.tscn");
		GetTree().ChangeSceneToFile("res://scenes/demoEnd.tscn");
	}
	public void _on_lvl_10_pressed()
	{
		//GetTree().ChangeSceneToFile("res://scenes/lvl_10.tscn");
		GetTree().ChangeSceneToFile("res://scenes/demoEnd.tscn");
